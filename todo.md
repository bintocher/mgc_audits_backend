...
218. [x] Создать Celery задачу для асинхронного экспорта



## Документация

219. [x] Создать README для проекта
220. [x] Создать инструкцию по установке
221. [x] Создать инструкцию по развертыванию
222. [x] Создать документацию по API

## Финальная проверка

223. [x] Провести code review
224. [x] Исправить найденные баги
225. [x] Проверить работу всех интеграций
226. [x] Проверить работу уведомлений
227. [x] Проверить работу отчетов

228. [x] Написать автотесты для всех эндпоинтов! Прокрытие тестами = 100%. Работоспособность тестов = 100%

229. [x] Подготовить к деплою на PROD
